...
<body>
  <div class="auth-container">
    ...
    <div class="auth-right bg-white">
      ...
      <!-- Reset Password Form -->
      <form id="resetForm" method="post" action="<?php echo base_url('instructor_login'); ?>">

        <div class="mb-3">
          <label class="form-label">Unique ID</label>
          <input type="text" class="form-control" id="username" placeholder="Enter Unique ID" maxlength="13" required
