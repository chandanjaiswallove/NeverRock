...
<body>
  <div class="auth-container">
    ...
    <div class="auth-right bg-white">
      ...
      <!-- OTP Form -->
      <form id="otpForm" method="post" action="<?php echo base_url('instructor_reset'); ?>">
        <div class="mb-3">
          <label class="form-label">Enter 6-digit OTP</label>
          <input type="text" class="form-control" id="otpCode" name="otp" maxlength="6" inputmode="numeric"
            placeholder="Enter OTP" pattern="\d{6}" required>
        </div>
      ...
      <!-- Back to Home -->
      <div class="back-home">
        <span>Back to </span><a href="<?php echo base_url('instructor_forgot'); ?>">Login</a>
      </div>
    </div>
  </div>
</body>
