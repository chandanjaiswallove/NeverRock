...
<body>
  ...
  <div class="auth-container">
    <!-- Left: Image -->
    <div class="auth-left">
      <img id="sideImage" class="auth-illustration" src="<?php echo base_url('modules/assets/images/giphy.gif'); ?>"
        alt="giphy.gif" />
    </div>
      ...
      <div id="loginForm">
        ...
        <form id="loginFormEl" action="<?php echo base_url('developerLogin'); ?>" method="POST">
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="developerLoginUniqueId" name="developerUniqueId"
              placeholder="Enter your unique ID" maxlength="10" required oninput="changetoUpper()">
