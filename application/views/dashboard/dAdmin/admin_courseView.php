            ...
            <div
                ...
                <div class="tab">
                    <div class="tab-links flex flex-wrap mb-10px lg:mb-50px rounded gap-10px" data-aos="fade-up">
                        ...
                        <a href="<?php echo base_url('admin_cdetailsedit'); ?>" id="courseDetailsTab" class="is-checked relative py-10px px-5 md:py-15px lg:px-10 font-bold uppercase text-sm lg:text-base 
