...
<div class="border border-borderColor dark:border-borderColor-dark rounded-md mb-4" data-aos="fade-up">
    ...
    <form action="<?= base_url('verifyCourseImportantTopic'); ?>" method="POST" enctype="multipart/form-data">
        ...
        <!-- BODY -->
        <div class="hidden px-6 pb-6">
            <div class="p-2 md:p-5 bg-darkdeep3 dark:bg-transparent text-sm text-blackColor dark:text-blackColor-dark space-y-4">

                <!-- TOPIC NAME -->
                <div class="group mb-2 bg-gray-100 dark:bg-gray-800 p-5 rounded-md border">
                    ...
                    <input type="text" id="important_topic" name="important_topic"
                           ...
                           class="w-full mt-2 py-2 px-3 text-sm bg-whiteColor dark:bg-whiteColor-dark border-2 rounded-md"
                ...
                <div id="importantKeyList" class="space-y-4">
                    <?php if (!empty($important_topics->keys)): ?>
                        <?php foreach ($important_topics->keys as $key): ?>
                            <div class="keyBox group mb-2 bg-gray-100 dark:bg-gray-800 p-5 rounded-md border">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 w-full place-items-center mt-4">
                    <button type="button" id="addKeyBtn" onclick="addImportantKey()"
                            class="text-sm text-whiteColor bg-secondaryColor border px-10px py-10px rounded disabled:bg-gray-400 disabled:text-white disabled:cursor-not-allowed">
                        + Add Key
                    </button>
                    <button type="submit"
                            class="text-sm text-whiteColor bg-primaryColor border px-10px py-10px rounded hover:text-primaryColor hover:bg-whiteColor">
                        Save
                    </button>
                </div>
