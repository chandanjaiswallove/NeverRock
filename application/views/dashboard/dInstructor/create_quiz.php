            ...
            <form id="quizForm"
                ...
                <div>
                    ...
                    <input type="text" id="quizTitle" placeholder="Enter Quiz Title"
                        class="w-full py-10px px-5 border-2 border-borderColor dark:border-borderColor-dark rounded-md bg-whiteColor dark:bg-whiteColor-dark" required>
                </div>
                ...
                <div class="mb-6 mt-6" data-aos="fade-up">
                    <button id="addQuizBtnTop" type="button"
                        class="py-10px px-5 md:py-15px lg:px-10 font-bold uppercase text-sm lg:text-base text-blackColor bg-whiteColor shadow-overview-button dark:bg-whiteColor-dark dark:text-blackColor-dark">
                        + Add Question
                    </button>
                </div>
