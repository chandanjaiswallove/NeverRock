        ...
        <div class="container-fluid-2 py-5">
                ...
                <div
                        ...
                        <div class="flex items-center flex-wrap justify-center sm:justify-start">
                                ...
                                <?php
                                $PhotoPath = 'modules/instructorPrPhoto/' . $instructor->instructor_photo;
                                if (empty($instructor->instructor_photo) || !file_exists(FCPATH . $PhotoPath)) {
                                ...
                                ?>
                                <div class="mr-5">
                                        <img src="<?php echo base_url($finalImage); ?>" alt="Instructor Photo"
                                ...
                                <div class="text-whiteColor font-bold text-center sm:text-start">
                                        ...
                                        <h2 class="text-2xl leading-1.24"><?php echo $instructor->instructor_name; ?>
                                        </h2>
                        ...
                        <div>
                                <a href="<?php echo base_url('create_lesson'); ?>"
