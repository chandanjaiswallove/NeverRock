...
<main class="">
    <div class="mb-5 mt-5 pt-50px md:mb-10" data-aos="fade-up">
        ...
        <h3
            ...
            𝗚𝗲𝘁 𝗶𝗻
            <span
                class="relative after:w-full after:h-[7px] z-0 after:bg-secondaryColor after:absolute after:left-0 after:bottom-3 md:after:bottom-5 after:z-[-1]">𝗧𝗼𝘂𝗰𝗵</span>
            <br>
    ...
    <section>
        <div class="container">
            <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-30px pt-100px pb-20  " data-aos="fade-up" >
                <!-- mail -->
                <div
    ...
    <section>
        <div class="container pb-100px">
            <form id="contact-form" action="https://html.themewin.com/edurcok-preview-tailwind/edurock/mail.php"
                method="post"
                ...
                <div class="grid grid-cols-1 xl:grid-cols-2 mb-30px gap-30px">
                    ...
                    <div data-aos="fade-up" class="relative">
                        <input name="con_email" id="con_email" type="email" placeholder="Enter Email Address*"
                            class="w-full pl-26px bg-transparent focus:outline-none text-contentColor dark:text-contentColor-dark border border-borderColor2 dark:border-borderColor2-dark placeholder:text-placeholder placeholder:opacity-80 h-15 leading-15 font-medium rounded">
                    ...
                    <div data-aos="fade-up" class="relative">
                        <input name="subject" type="text" placeholder="Write Service Type"
                            class="w-full pl-26px bg-transparent focus:outline-none text-contentColor dark:text-contentColor-dark border border-borderColor2 dark:border-borderColor2-dark placeholder:text-placeholder placeholder:opacity-80 h-15 leading-15 font-medium rounded">
                ...
                <div class="relative" data-aos="fade-up">
                    <textarea name="con_message" id="con_message" placeholder="Enter your Massage here"
    ...
    <section>
        <div class="container pb-100px">
            <div class="contact-form p-5 md:p-70px md:pt-90px border border-borderColor2 dark:border-transparent dark:shadow-container"
                data-aos="fade-up">
                ...
                <div class="mb-10">
                    ...
                    <p data-aos="fade-up"
                        class="text-size-13 md:text-base leading-5 md:leading-30px text-contentColor dark:text-contentColor-dark">
                        You can find our exact location on the map below. Feel free to visit us.
                    </p>
                </div>
                ...
                <div data-aos="fade-up">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4507.240492051537!2d84.50756917629136!3d26.799325176714994!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39936ebaf430839f%3A0x71294421cd88750d!2sSagar%20Pokhra%20Shiv%20Mandir!5e1!3m2!1sen!2sin!4v1758710008505!5m2!1sen!2sin"
