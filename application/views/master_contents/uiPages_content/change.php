    ...
    <div class="border border-borderColor dark:border-borderColor-dark rounded-md mb-4">
      ...
      <div class="hidden px-6 pb-6">
        <div class="p-5 bg-darkdeep3 dark:bg-transparent space-y-4">
          ...
          <?php if (!empty($features)): ?>
            <?php foreach ($features as $f): ?>
              <div class="group bg-gray-100 dark:bg-gray-800 p-5 rounded-md border">
                ...
                <input type="hidden" name="feature_id[]" value="<?= htmlspecialchars($f->id, ENT_QUOTES) ?>">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" name="featureKey[]" value="<?= htmlspecialchars($f->feature_value, ENT_QUOTES) ?>"
                    class="w-full py-2 px-3 border rounded-md">
                </div>
          ...
          <button type="button" onclick="addNewFeature()" class="px-5 py-2 bg-primaryColor text-white rounded mt-3">
            + Add More Features
          </button>
